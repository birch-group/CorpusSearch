...
public class SynTagList {
    ...
    private void Init() {
	list = new Vector();
	list.addElement(other_bucket); list.addElement(A_bucket);
	list.addElement(B_bucket); list.addElement(C_bucket);
	list.addElement(D_bucket); list.addElement(E_bucket);
	list.addElement(F_bucket); list.addElement(G_bucket);
	list.addElement(H_bucket); list.addElement(I_bucket);
	list.addElement(J_bucket); list.addElement(K_bucket);
	list.addElement(L_bucket); list.addElement(M_bucket);
	list.addElement(N_bucket); list.addElement(O_bucket);
	list.addElement(P_bucket); list.addElement(Q_bucket);
	list.addElement(R_bucket); list.addElement(S_bucket);
	list.addElement(T_bucket); list.addElement(U_bucket);
	list.addElement(V_bucket); list.addElement(W_bucket);
	list.addElement(X_bucket); list.addElement(Y_bucket);
