...
public class ErrorTextField {
    ...
    public ErrorTextField(int tool_width) {
	error_field = new TextField(start_message, tool_width/2);
	...
	error_field.setText("will " + func_name + ":  " + to_func); }

    public void willDo (String func_name, String to_func, String to_func2) {
	error_field.setText("will " + func_name + ":  " 
			    + to_func + ", " + to_func2); }
