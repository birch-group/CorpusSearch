...
public class UberSynList {
	...
	for (i = 0; i < this.size(); i++) {
	    ...
	    pail.Sort(); 
	    for (j = 0; j < pail.size(); j++) {
		lurk = pail.LexEntryAt(j);
		lurk.Sort(); } }
	return; }

    public void addFileList(FileSynList folly) {
	...
	try {
	    ...
	    System.err.println("in UberSynList.java: FileList:  ");
	...
	System.err.println("UberSynList:  ");
	if (start < 0) { start = 0; }
