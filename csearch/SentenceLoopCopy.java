...
/*
  ...
  this is "sentenceLoop.java", when copy_corpus is true.
*/
package csearch;
...
public class SentenceLoopCopy extends Meat {

    public SynTree sparse;
    private String dest_name;

    public SentenceLoopCopy() {
    }

    public String getDestName() { return dest_name; }
    ...
    */
	...
	ChangeTree changeable;
		...
		//OneResult.PrintToSystemErr();
			...
			Revisions.Plain(sparse, CommandInfo.tasker, 
					OneResult); }
		}
