...
/*
  ...
  Meat.java when do_local_frames is true.
*/
package csearch;
...
public class MeatFrames extends Meat{
    ...
    */
    public static void CrankThrough () {
	    ...
	    // Open output files, and print prefaces.
            ...
            System.err.println("Building Frames.  Please be patient.");
	    ParseFrames.makeFramesTree(new StringReader(CommandInfo.query));
		...
		if (file_name.endsWith(".out")) {
		    searching_output = true;
                ...
                LocalLoop.thruFile(file_name, OutStuff, 
				   search_info);
