...
public class MeatCoding extends Meat {
    ...
    */
    public static void CrankThrough () {
        ...
        try {
	    ParseCodingQuery.makeCodingQueryTree(new 
			     StringReader(CommandInfo.coding_query));
 	    PrintOut.PrefaceCoding(dest_name, command_name, 
		...
		if (file_name.endsWith(".out")) {
		    searching_output = true;
                ...
                CodingLoop.thruFile(file_name, OutStuff, 
				    search_info, CommandInfo.append_to_CODING);
