...
public class MeatReformat extends Meat{
    ...
    */
	...
	SentenceLoopReformat slurry = new SentenceLoopReformat();

        try {
            System.err.println("Reformatting.  Please be patient.");
		...
		if (file_name.endsWith(".out")) {
		    searching_output = true;
                ...
                slurry.thruFile(file_name);
		if (i == 0) { first = slurry.getDestName(); }
		if (i == source_list.size() - 1) { last = slurry.getDestName(); }
